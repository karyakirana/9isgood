...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql2')->create('pengeluaran_pembelian_detail', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('mysql2')->dropIfExists('pengeluaran_pembelian_detail');
    }
};
