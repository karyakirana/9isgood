                    ...
                    <div class="row">
                        <div class="col-6 mb-5">
                            <x-atoms.input.group-horizontal label="Supplier" name="supplier_id">
                                <x-atoms.input.text  data-bs-toggle="modal" data-bs-target="#modal_supplier" readonly/>
                            </x-atoms.input.group-horizontal>
                        </div>
                        <div class="col-6 mb-5">
                            <x-atoms.input.group-horizontal label="Tgl Nota" name="tgl_nota">
                                <x-atoms.input.singledaterange  id="tgl_nota" readonly/>
                            </x-atoms.input.group-horizontal>
                        </div>
                    </div>
                    <div class="row">
...
{{--                    @forelse($data_detail as $index=> $row)--}}
                        <tr>
                            ...
                            <x-atoms.table.td align="center">
                                <x-atoms.button.btn-icon ><i class="la la-edit fs-3"></i></x-atoms.button.btn-icon>
                                <x-atoms.button.btn-icon ><i class="la la-trash fs-3"></i></x-atoms.button.btn-icon>
                            </x-atoms.table.td>
                        </tr>
{{--                    @empty--}}
                        <tr>
        ...
        <div class="flex-lg-auto min-w-lg-300px">
            <x-molecules.card>
                ...
                <x-atoms.input.group label="Jumlah" name="jumlah">
                    <x-atoms.input.text class="text-end"  />
                </x-atoms.input.group>
                ...
                <div class="row mb-5">
                    ...
                    <div class="col">
                        @if($update==true)
                            <x-atoms.button.btn-info  class="w-100">Update</x-atoms.button.btn-info>
                        @else
                            <x-atoms.button.btn-info  class="w-100">Add</x-atoms.button.btn-info>
                        @endif
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                ...
                @else
                    <x-atoms.button.btn-primary  class="w-100">SIMPAN</x-atoms.button.btn-primary>
                @endif
            </x-molecules.card>
        </div>
        <!-- end:form cards-->
    ...
    <!-- begin:modal_produk -->
    <x-molecules.modal title="Daftar Produk" id="modal_produk" size="xl" >
    ...
    <x-molecules.modal title="Daftar Supplier" id="modal_supplier" size="xl" >
