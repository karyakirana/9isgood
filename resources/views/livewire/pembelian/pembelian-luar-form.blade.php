                ...
                <form>
                    <div class="row">
                        <div class="col-6 mb-5">
                            <x-atoms.input.group-horizontal label="Supplier" name="supplierNama">
                        ...
                        <div class="col-6 mb-5">
                            <x-atoms.input.group-horizontal label="Tgl Nota" name="tglNota">
                                <x-atoms.input.singledaterange wire:model.defer="tglNota" id="tglNota" readonly/>
                            </x-atoms.input.group-horizontal>
                        </div>
                    </div>
                    <div class="row">
        ...
        <div class="flex-lg-auto min-w-lg-300px">
            <x-molecules.card wire:ignore.self>
                ...
                <x-atoms.input.group label="Harga Beli" name="harga">
                    <x-atoms.input.text class="text-end" wire:model.defer="harga" wire:keyup="hitungSubTotal" wire:key="harga"/>
                </x-atoms.input.group>
                <x-atoms.input.group label="Jumlah" name="jumlah">
                    <x-atoms.input.text class="text-end" wire:model.defer="jumlah" wire:keyup="hitungSubTotal" wire:key="jumlah"/>
                </x-atoms.input.group>
