                    ...
                    <x-atoms.table>
                        ...
                        <x-slot name="footer">
                            <tr>
                                ...
                                <td colspan="2">
                                    <x-atoms.input.text name="totalPenjualanRupiah" wire:model.defer="totalPenjualanReturRupiah" readonly=""/>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">PPN</td>
                                <td colspan="2">
                                    <x-atoms.input.text name="ppn" wire:model.defer="ppn" wire:keyup="setTotalItem" />
                                </td>
                                <td></td>
                            </tr>
                            <tr>
