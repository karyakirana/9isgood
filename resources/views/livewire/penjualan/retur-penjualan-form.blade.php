                            ...
                            <div class="col-6">
                                <x-atoms.input.group-horizontal label="Tgl Nota" name="tglNota" required="required">
                                    <div class="input-group">
                                        <x-atoms.input.singledaterange id="tglNota" name="tglNota" wire:model.defer="tgl_nota"/>
                                    </div>
                                </x-atoms.input.group-horizontal>
                            </div>
                            <div class="col-6">
                                <x-atoms.input.group-horizontal label="Tgl Tempo" name="tglTempo" required="required">
                                    <div class="input-group">
                                        <x-atoms.input.singledaterange id="tglTempo" name="tglTempo" wire:model.defer="tgl_tempo"/>
                                    </div>
                                </x-atoms.input.group-horizontal>
                            </div>
                        </div>
