            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="click"
                             class="menu-item {{request()->is('master/produk*') ? 'here show' : ''}} menu-accordion">
                            <!--begin:Menu link-->
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{request()->is('master/produk') ? 'active' : ''}}"
                                       href="{{route('produk')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{request()->is('master/produk/kategori') ? 'active' : ''}}"
                                       href="{{route('produk.kategori')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{request()->is('master/produk/kategoriharga') ? 'active' : ''}}"
                                       href="{{route('produk.kategoriharga')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('master/gudang') ? 'active' : ''}}"
                               href="{{route('gudang')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('master/customer') ? 'active' : ''}}"
                               href="{{route('customer')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="click"
                             class="menu-item {{request()->is('master/supplier*') ? 'here show' : ''}} menu-accordion">
                            <span class="menu-link">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                            ...
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                                    <a class="menu-link {{request()->is('master/supplier') ? 'active' : ''}}"
                                       href="{{route('supplier')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{request()->is('master/supplier/jenis') ? 'active' : ''}}"
                                       href="{{route('supplier.jenis')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                ...
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click"
                     class="menu-item {{request()->is('master/pegawai*') ? 'here show' : ''}} menu-accordion">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('master/pegawai') ? 'active' : ''}}"
                               href="{{route('pegawai')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <!--begin:Menu item-->
                <div data-kt-menu-trigger="click"
                     class="menu-item {{request()->is('penjualan*') ? 'here show' : ''}} menu-accordion">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('penjualan') ? 'active' : ''}}"
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('penjualan/trans') ? 'active' : ''}}"
                               href="{{route('penjualan.trans')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('penjualan/retur/baik') ? 'active' : ''}}"
                               href="{{url('/').'/penjualan/retur/baik'}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('penjualan/retur/baik/trans') ? 'active' : ''}}"
                               href="{{url('/').'/penjualan/retur/baik/trans'}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('penjualan/retur/rusak') ? 'active' : ''}}"
                               href="{{url('/').'/penjualan/retur/rusak'}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('penjualan/retur/rusak/trans') ? 'active' : ''}}"
                               href="{{url('/').'/penjualan/retur/rusak/trans'}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('pembelian') ? 'active' : ''}}"
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('pembelian/trans') ? 'active' : ''}}"
                               href="{{route('pembelian.trans')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('pembelian/retur/baik') ? 'active' : ''}}"
                               href="{{url('/').'/pembelian/retur/baik'}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Retur Baik</span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('pembelian/retur/baik/trans') ? 'active' : ''}}"
                               href="{{url('/').'/pembelian/retur/baik/trans'}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Retur Baik Baru</span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('pembelian/retur/rusak') ? 'active' : ''}}"
                               href="{{url('/').'/pembelian/retur/rusak'}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Retur Rusak</span>
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{request()->is('pembelian/retur/rusak/trans') ? 'active' : ''}}"
                               href="{{url('/').'/pembelian/retur/rusak/trans'}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Retur Rusak Baru</span>
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <!--begin:Menu sub-->
                    <div class="menu-sub menu-sub-accordion">
                        <x-organisms.menu.sidebar-stock />
                    </div>
                    <!--end:Menu sub-->
                </div>
                <!--end:Menu item-->
                ...
                <div data-kt-menu-trigger="click"
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <!--begin:Menu item-->
                        <div data-kt-menu-trigger="click"
                             class="menu-item {{request()->is('generator/persediaan/*') ? 'here show' : ''}} menu-accordion">
                            <!--begin:Menu link-->
                            <span class="menu-link">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{request()->is('generator/persediaan/stockopname') ? 'active' : ''}}"
                                       href="{{route('generator.persediaan.stockopname')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{request()->is('generator/persediaan/pembelian-internal') ? 'active' : ''}}"
                                       href="{{route('generator.persediaan.pembelian-internal')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Pembelian Internal</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{request()->is('generator/persediaan/pembelian-eksternal') ? 'active' : ''}}"
                                       href="{{route('generator.persediaan.pembelian-eksternal')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Pembelian Eksternal</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{request()->is('generator/persediaan/penjualan') ? 'active' : ''}}"
                                       href="{{route('generator.persediaan.penjualan')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Penjualan</span>
                                ...
                                <div class="menu-item">
                                    <!--begin:Menu link-->
                                    <a class="menu-link {{request()->is('generator/persediaan/penjualan-retur') ? 'active' : ''}}"
                                       href="{{route('generator.persediaan.penjualan-retur')}}">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
                                        <span class="menu-title">Penjualan Retur</span>
                                    </a>
                                    <!--end:Menu link-->
                                </div>
                                <!--end:Menu item-->
